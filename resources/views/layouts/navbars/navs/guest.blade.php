<nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
    <div class="container px-4">
        <a class="navbar-brand" href="{{ route('home') }}">
            <img style="height:110px" src="{{ asset('argon') }}/img/brand/posyandu-white.png" />
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('agenda.user') }}">
                        <i class="fas fa-calendar"></i>
                        <span class="nav-link-inner--text">{{ __('Agenda') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('artikel') }}">
                        <i class="fas fa-newspaper"></i>
                        <span class="nav-link-inner--text">{{ __('Artikel') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('kontak') }}">
                        <i class="fas fa-address-book"></i>
                        <span class="nav-link-inner--text">{{ __('Kontak') }}</span>
                    </a>
                </li>
                <li class="nav-item">
