        ...
        <div class="row">
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h1 mb-0 text-gray-800">Ubah Data Perkembangan Balita</h1>
                </div>
                <form method="post" action="/growth/{{ $growth->id }}/update" class="mb-5"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <input required class="form-control @error('control_date') is-invalid @enderror" type="date"
                                ...
                                value="{{ old('control_date', date('Y-m-d', strtotime($growth->control_date))) }}">
                            @error('control_date')
